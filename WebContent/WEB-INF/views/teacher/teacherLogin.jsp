...
<body background="<c:url value='/images/cloude.png'/>">
      <div class="myBorder" style="background:url(<c:url value='/images/bg2.png'/>)">
            <div class="login">
               <div class="row">
                  <div class="col-sm-1 myImage">
                        <img src="<c:url value='/images/teacherLogin.png'/>" width="600" alt="老师登录">
                  </div>
               </div>
               <form action="${pageContext.request.contextPath}/teacherLogin" method="post">
                  <div class="form-group">
                        <div class="row">
                              ...
                              <!--输入框不能直接用栅格系统-->
                              <div class="col-sm-5">
                                    <input type="text" name="tno" id="studentId" placeholder="长度为12位的数字" class="form-control">
                              </div>
